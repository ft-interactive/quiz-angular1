...
app.controller('QuestionCtrl', ['$scope', '$timeout', '$window',
  function ($scope, $timeout, $window) {
    $scope.submitAnswer = function () {
      ...
      $scope.correctAnswer = $scope.questions[$scope.questionsAnswered.value].answer;

      // If this is the first question, log a start in GA
      if ($scope.questionsAnswered.value === 0) {
      ...
      if ($scope.userAnswer === $scope.correctAnswer) {
        ...
        $window.ga('send', 'event',
          ($scope.questionsAnswered.value < 9 ? '0' : null) +
          ($scope.questionsAnswered.value + 1) + '. ' +
          $scope.questions[$scope.questionsAnswered.value].question,
      ...
      if ($scope.questionsAnswered.value === $scope.questions.length - 1) {
